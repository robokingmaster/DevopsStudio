...
red-app     redapp-ingress    alb     redapp.eislabs.net            k8s-frontend-xxxxxxxxxx.xxxxxxxxxx.us-east-2.elb.amazonaws.com   80      17h
```
...
alb.ingress.kubernetes.io/inbound-cidrs: 103.38.88.0/24,103.253.104.0/24      ---Allow Incoming requests only from These CIRDS
```
